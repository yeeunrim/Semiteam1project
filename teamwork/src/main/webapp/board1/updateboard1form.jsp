...
<body>
	...
	<section id="writeform">
		...
		<form action="/updateboard1.do" method="post">
			<!-- 'hidden'은 ui를 만들지 않고 데이터 숨겨서 보낼때 사용 -->
			<input type="hidden" name="bno" value="${board1.bno1}">
			<table>
				<tbody>
					<tr>
					<td><input type="text" name="title" value="${board1.title1 }"></td>
				</tr>
				<tr>
					<td><textarea rows="7" cols="100" name="content">${board1.content1 }</textarea></td>
				</tr>
				<tr>
					<td>${board1.id }</td>
				</tr>
