              ...
              <div class="slider_img">
                <div class="slider_inner">
                  ...
                  <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/festival/canival.jpg" class="img-fluid rounded-start" alt="카니발">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                  ...
                  <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/festival/lucia.png" class="img-fluid rounded-start" alt="루시아">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                  ...
                  <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/festival/dubai.jpg" class="img-fluid rounded-start" alt="두바이">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
