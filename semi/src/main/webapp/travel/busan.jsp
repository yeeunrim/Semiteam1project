	...
	<jsp:include page="../header.jsp" />
	 ...
	 <section>
        ...
        <div id="curation_content">
            ...
            <a href="https://blog.naver.com/lhskyy8675/222845076948" target="_blank"
                class="curationBox"> 
                <div class="imgBox1"> 
                    <img class="img" src="images/Busan/nagyung_busan.png" alt="thebay101">
                </div>

                <div class="textBox1"> 
                    <div class="Ctext1">
                        <p><br></p>
                        <p><small>부산 야경 명소 더베이101</small><br>야경 쥑이네~</p>
                    </div>
                </div>
            </a>
            ...
            <a href="https://blog.naver.com/busanto1115/223108136057" target="_blank"
                ...
                <div class="textBox4">
                    <div class="Ctext4">
                         <p><small>비오는 날 오히려 좋아!<br>부산 시티투어버스 이용법</small></p> 
                    </div>
                </div>
            </a>
