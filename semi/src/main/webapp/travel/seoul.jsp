...
<body>
	...
	<section>
        ...
        <div id="curation_content">
            ...
            <a href="https://blog.naver.com/80sunjin/223274280325?&isInf=true" target="_blank"
                class="curationBox"> 
                <div class="imgBox2">
                    <img class="img" src="images/Seoul/yeeun_seoul.png" alt="traditional hanok">
                </div>
                <div class="textBox2">
                    <div class="Ctext2">
                        <p>도시와 궁궐의 만남,<br>서울 창덕궁 나들이..</p>
                    </div>
                </div>
            </a>
            
            <a href="https://blog.naver.com/travel_haji/222986799108?&isInf=true" 
                target="_blank"  class="curationBox"> 
                <div class="imgBox3">
                    <img class="img" src="images/Seoul/nagyung_seoul.png" alt="drawing">
                </div>
                <div class="textBox3">
                    <div class="Ctext3">
                        <p>서울 이색체험,<br>드로잉 카페 추천!</p>
                    </div>
                </div>
            </a>
